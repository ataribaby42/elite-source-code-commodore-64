#!/usr/bin/env python3
"""ROM/turbo pulse codec extracted from 2-build-files/elite-tape.py.

The original encoder and round-trip verifiers are retained unchanged.
No external PRG-to-TAP tool is required. See the repository LICENSE.
"""
