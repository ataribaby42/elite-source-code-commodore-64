...
.DIALSRLEEND
 ...
 INCBIN "3-assembled-output/C128-RASTER.bin"
.C128RASTEREND

 ASSERT C128RASTEREND - DIALS <= $4D6

 SKIP $4D6 - (C128RASTEREND - DIALS)

 INCBIN "3-assembled-output/BOUNTY-HUNTER-COMMS.bin"

.BOUNTYHUNTERCOMMSEND

 ASSERT BOUNTYHUNTERCOMMSEND - DIALS <= $500

 SKIP $500 - (BOUNTYHUNTERCOMMSEND - DIALS)
